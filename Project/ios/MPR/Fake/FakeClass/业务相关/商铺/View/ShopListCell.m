...
- (void)setupContentView
{
    ...
    lineView.backgroundColor = [UIColor colorWithHexString:@"#cccccc" alpha:1.0];
...
//    [orderButton setTitle:@"预定" forState:UIControlStateNormal];
//    [orderButton setBackgroundImage:[UIImage imageNamed:@"anniu_black_xian"] forState:UIControlStateNormal];
//    [orderButton.titleLabel setFont:[UIFont systemFontOfSize:12]];
//    [orderButton setTitleColor:[UIColor colorWithHexString:@"#1a1a1a"] forState:UIControlStateNormal];
...
//        make.top.mas_equalTo(orderButton.mas_bottom).offset(8);
...
//    bookVC.price = self.shopListModel.price;
//    bookVC.spaceId = self.shopListModel.roomId;
////    bookVC.messageModel = self.spaceDetailMessageModel;
//    [self.viewController.navigationController pushViewController:bookVC animated:NO];
//}
