...
@interface MineTView()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) NSArray *menuArray;
@end

@implementation MineTView
...
//        WSFOrderListVC *orderListVC = [[WSFOrderListVC alloc] init];
//        [self.viewController.navigationController pushViewController:orderListVC animated:NO];
...
{
    if (!_menuArray) {
        _menuArray = @[@"赢贝", @"优惠券", @"我的订单", @"我的空间", @"推荐有礼", @"意见反馈", @"关于我们", @"退出当前帐号"];
    }
    return _menuArray;
}
