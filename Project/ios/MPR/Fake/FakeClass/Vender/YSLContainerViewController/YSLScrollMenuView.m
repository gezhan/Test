...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //-----根据项目需求
        _itemTitleColor = [UIColor colorWithHexString:@"#1a1a1a"];
        _itemSelectedTitleColor = [UIColor colorWithHexString:@"#2b84c6"];
        _itemIndicatorColor = [UIColor colorWithHexString:@"#ffffff"];
        //-----
