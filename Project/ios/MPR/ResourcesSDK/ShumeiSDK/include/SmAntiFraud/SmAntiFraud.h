...
@interface SmAntiFraud : NSObject {
    OnServerIdReceive _idCallback;
}

@property(readwrite, copy) OnServerIdReceive idCallback;
 ...
 * 返回值：deviceId类型，0-本地id，1-服务端id，2-旧版id，-1-伪造id，-2-获取id类型失败
 */
 ...
 */
-(void) registerServerIdCallback:(OnServerIdReceive) onReceive;
