    ...
    if (self) {
        ...
        @try {
            ...
            if (![UdeskTools isBlankString:productDetail]) {
                ...
                self.productDetailFrame = CGRectMake(CGRectGetMinX(self.productTitleFrame), self.productTitleFrame.origin.y+self.productTitleFrame.size.height+ kUDProductDetailToTitleVerticalEdgeSpacing, UD_SCREEN_WIDTH - CGRectGetMinX(self.productTitleFrame) - kUDProductSendButtonWidth - 10, kUDProductDetailHeight);
            }
