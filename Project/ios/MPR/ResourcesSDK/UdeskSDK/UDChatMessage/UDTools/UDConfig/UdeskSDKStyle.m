...
- (instancetype)init
{
    ...
    if (self) {
        ...
        self.customerBubbleColor = [UIColor colorWithHexString:@"#4e89eb"];
        ...
        //nav
        self.navBackButtonColor = [UIColor colorWithHexString:@"#333333"];
        self.navBackButtonImage = [UIImage imageNamed:@"back_black"];
        self.navigationColor = [UIColor colorWithHexString:@"#4e89eb"];
        ...
        //right
        self.transferButtonColor = [UIColor colorWithHexString:@"#FAFAFA"];
