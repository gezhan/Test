...
- (void)updateNavAttributesWithViewController:(UIViewController *)viewController
    ...
    if (_sdkConfig.presentingAnimation == UDTransiteAnimationTypePresent) {
        ...
        CGSize backTextSize = [UdeskStringSizeUtil textSize:backText withFont:[UIFont systemFontOfSize:17] withSize:CGSizeMake(15, 30)];
        
        UIButton *leftBarButton = [UIButton buttonWithType:UIButtonTypeCustom];
        leftBarButton.frame = CGRectMake(0, 0, backTextSize.width+backImage.size.width, backTextSize.height);
...
//      UIButton *button = [[UIButton alloc]initWithFrame:CGRectMake(50, 0, 50, 30)];
//      [button setImage:[UIImage imageNamed:@"phone"] forState:UIControlStateNormal];
//      [button addTarget:viewController action:@selector(openPhone) forControlEvents:UIControlEventTouchUpInside];
//      UIBarButtonItem *rBtn = [[UIBarButtonItem alloc]initWithCustomView:button];
//      viewController.navigationItem.rightBarButtonItem =rBtn;
